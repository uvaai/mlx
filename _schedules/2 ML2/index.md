...
## Course syllabus<br><small></small>
...
what types of problems they can be applied. For ML2 we'll be focusing more on
combining smaller models as components into bigger and more complex models, most
notably neural networks. The course consists of 5 modules and a bonus module. Each of these modules
is expected to take 2 weeks, and will focus on exploring one or more techniques from machine learning.
...
questions. *Please pre-fix the subject of your email with* "LLL ML2".
...
If you've submitted something after the deadline, you are not guaranteed to get feedback on your work.

## Scheduled classes

All classes are scheduled on Tuesday from 14:00 to 16:00 during the 12 week
period of the course, with a separate kick-off session the Tuesday before we
start. The full course schedule is available as a PDF on the Life Long Learning website.

### Kick-off session

Here we'll introduce the format of the course, give a quick recap of ML1, and help with any installation
...
* Tuesday, September 29th, 14:00-16:00, LAB42 room L3.35 (third floor).
...
All Q&A sessions will take place in room **L0.11** in *LAB42*.
...
* Tuesday, December 8th, 14:00-16:00, location TBD
